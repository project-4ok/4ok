    ...
    assert output["related_objects"] == [
        {
            ...
            "object_type": "Person",
            "title": "Olivia Smith",
            "relationship_to_primary": "linked entity: assignee, author, commenter",
        ...
        },
        {
            ...
            "object_type": "Person",
            "title": "Robin Scharf",
            "relationship_to_primary": "linked entity: mentioned_person",
            "relationship_source_refs": ["linear:issue:ABC-123"],
            "confidence": 1.0,
            "follow_up_hint": "Ask about Robin Scharf",
        },
        {

...
def test_operator_status_default_resolves_compose_database_url_from_env_file(
    ...
    monkeypatch.setattr("fourok.runtime.cli._running_app_database_url", lambda: "")
...
def test_operator_status_default_prefers_compose_env_over_stale_shell_env(
    ...
    monkeypatch.setattr("fourok.runtime.cli._running_app_database_url", lambda: "")
    monkeypatch.setattr(
        "fourok.runtime.cli.operator_environment",
        lambda _root: {
...
def test_operator_status_default_prefers_running_app_database_url(
    ...
    monkeypatch.setattr(
        "fourok.runtime.cli._running_app_database_url",
...
def test_running_app_database_url_discovers_compose_app_container(monkeypatch) -> None:
    from fourok.runtime import cli as commands_runtime
...
def test_cli_health_uses_container_database_env_without_rewrite(capsys, monkeypatch) -> None:
    ...
    monkeypatch.setattr("fourok.runtime.cli._running_in_container", lambda: True)
    monkeypatch.setattr(
        "fourok.runtime.cli.create_governed_context_state",
        fake_create_state,
    )
...
def test_cli_operator_status_keeps_explicit_default_state_path(
    ...
    monkeypatch.setattr("fourok.runtime.cli._running_app_database_url", lambda: "")
    monkeypatch.setattr(
        "fourok.runtime.cli._context_state_from_args",
        fake_context_state,
    )
    monkeypatch.setattr(
        "fourok.runtime.cli.operator_status",

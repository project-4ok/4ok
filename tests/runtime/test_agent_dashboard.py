...
def test_4ok_dashboard_starts_with_agent_runtime_coverage_row() -> None:
    ...
    assert dashboard["title"] == "4ok dashboard"
    ...
    expected_top_stat_panels = {
        ...
        "[Agent] Recent Loki 4ok log streams": 'count(count_over_time({compose_project=~"$compose_project"}[15m]))',

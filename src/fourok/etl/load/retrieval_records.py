...
def prepare_retrieval_records(
    ...
    *,
    ...
    with tracer.start_as_current_span("fourok.retrieval.prepare") as span:
        ...
        span.set_attribute("fourok.retrieval.unit_count", len(retrieval_records))
        span.set_attribute("fourok.retrieval.max_words", max_words)
        span.set_attribute("fourok.retrieval.overlap_words", overlap_words)
        record_counter("fourok_retrieval_prepare_total")
        record_histogram("fourok_source_records_prepared", len(records))
        record_histogram("fourok_retrieval_units", len(retrieval_records))

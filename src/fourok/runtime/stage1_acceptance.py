...
from fourok.devtools.dev import dagster_status_report
...
def grafana_dashboard_report(
    *,
    grafana_url: str,
    dashboard_uid: str = "fourok-local-runtime-logs",
) -> dict[str, object]:
    ...
    freshness_query = (
        "(time() - fourok_dagster_last_success_timestamp_seconds"
        '{exported_job="fourok_hourly_live_backfill"}) / 60'
    )

...
CONNECTOR_TAP_CONTRACTS = (
    ConnectorTapContract(
        name="gmail_fixture",
        source="gmail",
        tap_name="tap-gcb-fixture",
        job_name="singer-fixture-to-raw",
        fixture_path=Path("fixtures/connectors/singer_email_messages.jsonl"),
    ...
    ConnectorTapContract(
        name="slack_fixture",
        source="slack",
        tap_name="tap-gcb-slack-fixture",
        job_name="singer-slack-fixture-to-raw",
        fixture_path=Path("fixtures/connectors/singer_slack_messages.jsonl"),
    ...
    ConnectorTapContract(
        name="twenty_fixture",
        source="twenty",
        tap_name="tap-gcb-twenty-fixture",
        job_name="singer-twenty-fixture-to-raw",
        fixture_path=Path("fixtures/connectors/singer_twenty_crm.jsonl"),
    ...
    ConnectorTapContract(
        name="linear_fixture",
        source="linear",
        tap_name="tap-gcb-linear-fixture",
        job_name="singer-linear-fixture-to-raw",
        fixture_path=Path("fixtures/connectors/singer_linear_work_items.jsonl"),
    ...
    ConnectorTapContract(
        ...
        source="google_drive",
        tap_name="tap-gcb-google-drive-fixture",
        job_name="singer-google-drive-fixture-to-raw",
        fixture_path=Path("fixtures/connectors/singer_google_drive_docs.jsonl"),

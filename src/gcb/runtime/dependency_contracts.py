...
DEPENDENCY_CONTRACTS = (
    ...
    DependencyContract(
        ...
        category="connector-boundary",
        active_surface="GCB tap-gcb-twenty REST extraction, state, raw landing, and adapter",
        status="proved",
        dimensions=REQUIRED_DIMENSIONS,
        proof_commands=(
    ...
    DependencyContract(
        ...
        category="connector-boundary",
        active_surface="GCB tap-gcb-linear GraphQL extraction, state, raw landing, and adapter",
        status="proved",
        dimensions=REQUIRED_DIMENSIONS,
        proof_commands=(
    ...
    DependencyContract(
        ...
        category="connector-boundary",
        active_surface="GCB tap-gcb-google-drive OAuth extraction, state, raw landing, and adapter",
        status="proved",
        dimensions=REQUIRED_DIMENSIONS,
        proof_commands=(
    ...
    DependencyContract(
        ...
        proof_commands=(
            ...
            "--endpoint http://observability:4318 --service-name gcb-compose-smoke",
        ),
        notes=(
    ...
    DependencyContract(
        ...
        active_surface=(
            "chat capture adapter, gcb_search_context contract, and local OpenClaw plugin"
        ),

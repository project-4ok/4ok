...
from gcb.etl.extract.google_drive_adapter import google_drive_file_source_record_from_raw
from gcb.etl.extract.linear_adapter import (
...
from gcb.etl.extract.source_records import SourceAttachment, SourceIdentity, SourceRecord
    ...
    with critical_span(
        ...
        set_safe_span_attributes(
            span,
            {
                ...
                "gcb.raw_landing.record_count": report.record_count,
                "gcb.raw_landing.stream_count": len(report.streams),
                "gcb.raw_landing.schema_message_count": report.schema_messages,
                "gcb.raw_landing.state_message_count": report.state_messages,
            },
        )
        return report

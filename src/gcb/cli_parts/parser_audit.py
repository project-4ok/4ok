...
def add_audit_commands(subparsers) -> None:
    ...
    audit_parser.add_argument("--database-url", default=os.environ.get("GCB_DATABASE_URL"))
    ...
    audit_summary_parser.add_argument("--database-url", default=os.environ.get("GCB_DATABASE_URL"))

...
def add_runtime_commands(subparsers) -> None:
    ...
    stage1_parser.add_argument("--database-url", default=os.environ.get("GCB_DATABASE_URL"))
    ...
    acceptance_parser.add_argument("--database-url", default=os.environ.get("GCB_DATABASE_URL"))
    ...
    acceptance_parser.add_argument(
        "--backup-database-url",
        default=os.environ.get("GCB_BACKUP_DATABASE_URL") or os.environ.get("GCB_DATABASE_URL"),
    )
    acceptance_parser.add_argument(
        "--backup-output",
        type=Path,
    ...
    acceptance_parser.add_argument(
        ...
        default=os.environ.get("OTEL_SERVICE_NAME", "gcb-acceptance-proof"),
    )
    ...
    dashboard_parser.add_argument("--database-url", default=os.environ.get("GCB_DATABASE_URL"))
    ...
    monitor_parser.add_argument("--database-url", default=os.environ.get("GCB_DATABASE_URL"))

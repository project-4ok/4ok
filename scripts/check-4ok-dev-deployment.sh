...
GCB_CRITICAL_CONTAINERS="${GCB_CRITICAL_CONTAINERS:-openclaw-openclaw-gateway-1,openclaw-gcb-app-1,openclaw-gcb-postgres-1,openclaw-gcb-dagster-code-1,openclaw-gcb-dagster-postgres-1,openclaw-gcb-observability-1}"
